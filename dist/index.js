...
conversations.get("/:id", async (c) => {
  ...
  const { results: messages2 } = await c.env.DB.prepare(
...
var SYSTEM_PROMPT = `You are a helpful AI assistant. Always respond with structured JSON when sources are available.
